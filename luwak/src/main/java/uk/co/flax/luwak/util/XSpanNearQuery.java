 ...
 *
 */
public class XSpanNearQuery extends SpanQuery {
    ...
    public class XSpanNearWeight extends SpanWeight {
        ...
        public Spans getSpans(final LeafReaderContext context, Postings requiredPostings) throws IOException {
            ...
            return (!inOrder) ? new NearSpansUnordered(this, slop, subSpans, getSimScorer(context))
                    : new XNearSpansOrdered(this, slop, subSpans, getSimScorer(context));
        }
    ...
    public boolean equals(Object o) {
        ...
        final XSpanNearQuery spanNearQuery = (XSpanNearQuery) o;
